...
import { getAgentKey, sortAgentsForFoundryDefault } from '@/renderer/pages/guid/hooks/agentSelectionUtils';
...
const LocalAgents: React.FC = () => {
  ...
  const orderedDetectedAgents = sortAgentsForFoundryDefault(detectedAgents);
